...
export default function FFCMenuPage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {menuItems.addOns.map((item, index) => (
                <Card key={index} className="border-rose-100 bg-rose-50">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-rose-800 to-rose-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <FFCBookNowButton pageTitle="Menu Page" className="text-lg px-8 py-6 bg-white text-rose-800 hover:bg-rose-50" />
