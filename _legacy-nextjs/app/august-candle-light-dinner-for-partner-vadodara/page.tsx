...
const keyword = getKeywordBySlug('candlelight-dinner', 'august-candle-light-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/august-candle-light-dinner-for-partner-vadodara',
  },
};
