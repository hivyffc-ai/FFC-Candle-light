...
const keyword = getKeywordBySlug('candlelight-dinner', 'birthday-candlelight-dinner-for-lover-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/birthday-candlelight-dinner-for-lover-vadodara',
  },
};
