...
const keyword = getKeywordBySlug('candlelight-dinner', 'november-candlelight-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/november-candlelight-dinner-for-soulmate-vadodara',
  },
};
