...
const keyword = getKeywordBySlug('candlelight-dinner', 'october-candlelight-dinner-for-fiancee-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-candlelight-dinner-for-fiancee-vadodara',
  },
};
