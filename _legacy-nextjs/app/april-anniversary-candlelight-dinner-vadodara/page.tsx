...
const keyword = getKeywordBySlug('candlelight-dinner', 'april-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/april-anniversary-candlelight-dinner-vadodara',
  },
};
