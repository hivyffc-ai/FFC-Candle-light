...
const keyword = getKeywordBySlug('candlelight-dinner', 'may-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/may-valentines-day-candlelight-dinner-vadodara',
  },
};
