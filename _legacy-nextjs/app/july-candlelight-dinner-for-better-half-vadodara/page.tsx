...
const keyword = getKeywordBySlug('candlelight-dinner', 'july-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/july-candlelight-dinner-for-better-half-vadodara',
  },
};
