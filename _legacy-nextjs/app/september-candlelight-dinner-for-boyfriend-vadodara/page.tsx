...
const keyword = getKeywordBySlug('candlelight-dinner', 'september-candlelight-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/september-candlelight-dinner-for-boyfriend-vadodara',
  },
};
