...
const keyword = getKeywordBySlug('candlelight-dinner', 'honeymoon-candlelight-dinner-for-wife-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/honeymoon-candlelight-dinner-for-wife-vadodara',
  },
};
