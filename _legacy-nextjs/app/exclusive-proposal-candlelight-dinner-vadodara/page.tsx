...
const keyword = getKeywordBySlug('candlelight-dinner', 'exclusive-proposal-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/exclusive-proposal-candlelight-dinner-vadodara',
  },
};
