...
const keyword = getKeywordBySlug('candlelight-dinner', 'exclusive-candlelight-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/exclusive-candlelight-dinner-for-boyfriend-vadodara',
  },
};
