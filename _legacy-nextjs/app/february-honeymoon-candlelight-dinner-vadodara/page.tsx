...
const keyword = getKeywordBySlug('candlelight-dinner', 'february-honeymoon-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/february-honeymoon-candlelight-dinner-vadodara',
  },
};
