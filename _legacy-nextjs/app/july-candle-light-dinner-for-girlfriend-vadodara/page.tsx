...
const keyword = getKeywordBySlug('candlelight-dinner', 'july-candle-light-dinner-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/july-candle-light-dinner-for-girlfriend-vadodara',
  },
};
