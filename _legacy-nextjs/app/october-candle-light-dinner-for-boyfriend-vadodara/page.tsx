...
const keyword = getKeywordBySlug('candlelight-dinner', 'october-candle-light-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-candle-light-dinner-for-boyfriend-vadodara',
  },
};
