...
const keyword = getKeywordBySlug('candlelight-dinner', 'private-honeymoon-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/private-honeymoon-candlelight-dinner-vadodara',
  },
};
