...
const keyword = getKeywordBySlug('candlelight-dinner', 'intimate-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-valentines-day-candlelight-dinner-vadodara',
  },
};
