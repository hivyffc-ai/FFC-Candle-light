...
const keyword = getKeywordBySlug('candlelight-dinner', 'march-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/march-valentines-day-candlelight-dinner-vadodara',
  },
};
