...
const keyword = getKeywordBySlug('candlelight-dinner', 'candlelight-dinner-for-valentines-day-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/candlelight-dinner-for-valentines-day-vadodara',
  },
};
