...
const keyword = getKeywordBySlug('candlelight-dinner', 'candlelight-dinner-with-fireworks-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/candlelight-dinner-with-fireworks-for-better-half-vadodara',
  },
};
