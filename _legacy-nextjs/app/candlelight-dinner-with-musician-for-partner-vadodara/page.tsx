...
const keyword = getKeywordBySlug('candlelight-dinner', 'candlelight-dinner-with-musician-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/candlelight-dinner-with-musician-for-partner-vadodara',
  },
};
