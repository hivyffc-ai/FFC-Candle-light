...
const keyword = getKeywordBySlug('candlelight-dinner', 'candlelight-dinner-for-monthly-anniversary-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/candlelight-dinner-for-monthly-anniversary-vadodara',
  },
};
