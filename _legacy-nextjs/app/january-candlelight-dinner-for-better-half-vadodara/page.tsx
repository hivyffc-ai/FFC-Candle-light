...
const keyword = getKeywordBySlug('candlelight-dinner', 'january-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/january-candlelight-dinner-for-better-half-vadodara',
  },
};
