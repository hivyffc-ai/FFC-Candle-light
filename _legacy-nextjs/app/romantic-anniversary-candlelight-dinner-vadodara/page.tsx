...
const keyword = getKeywordBySlug('candlelight-dinner', 'romantic-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-anniversary-candlelight-dinner-vadodara',
  },
};
