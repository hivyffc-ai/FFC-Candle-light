...
const keyword = getKeywordBySlug('candlelight-dinner', 'november-honeymoon-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/november-honeymoon-candlelight-dinner-vadodara',
  },
};
