...
const keyword = getKeywordBySlug('candlelight-dinner', 'dreamy-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/dreamy-valentines-day-candlelight-dinner-vadodara',
  },
};
