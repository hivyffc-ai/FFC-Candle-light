...
const keyword = getKeywordBySlug('candlelight-dinner', 'romantic-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
