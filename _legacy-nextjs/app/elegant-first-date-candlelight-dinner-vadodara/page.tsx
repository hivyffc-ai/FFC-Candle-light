...
const keyword = getKeywordBySlug('candlelight-dinner', 'elegant-first-date-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/elegant-first-date-candlelight-dinner-vadodara',
  },
};
