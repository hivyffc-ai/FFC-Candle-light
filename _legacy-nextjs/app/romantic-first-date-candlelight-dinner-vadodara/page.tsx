...
const keyword = getKeywordBySlug('candlelight-dinner', 'romantic-first-date-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-first-date-candlelight-dinner-vadodara',
  },
};
