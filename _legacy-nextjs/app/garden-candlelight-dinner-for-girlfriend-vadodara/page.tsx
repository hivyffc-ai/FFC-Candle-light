...
const keyword = getKeywordBySlug('candlelight-dinner', 'garden-candlelight-dinner-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/garden-candlelight-dinner-for-girlfriend-vadodara',
  },
};
