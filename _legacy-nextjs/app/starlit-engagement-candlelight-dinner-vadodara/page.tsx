...
const keyword = getKeywordBySlug('candlelight-dinner', 'starlit-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/starlit-engagement-candlelight-dinner-vadodara',
  },
};
