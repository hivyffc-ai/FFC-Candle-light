...
const keyword = getKeywordBySlug('candlelight-dinner', 'june-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/june-candlelight-dinner-for-better-half-vadodara',
  },
};
