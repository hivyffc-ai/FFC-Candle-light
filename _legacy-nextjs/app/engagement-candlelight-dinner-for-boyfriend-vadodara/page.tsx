...
const keyword = getKeywordBySlug('candlelight-dinner', 'engagement-candlelight-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/engagement-candlelight-dinner-for-boyfriend-vadodara',
  },
};
