...
const keyword = getKeywordBySlug('candlelight-dinner', 'september-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/september-valentines-day-candlelight-dinner-vadodara',
  },
};
