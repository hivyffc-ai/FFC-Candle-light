...
const keyword = getKeywordBySlug('candlelight-dinner', 'january-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/january-valentines-day-candlelight-dinner-vadodara',
  },
};
