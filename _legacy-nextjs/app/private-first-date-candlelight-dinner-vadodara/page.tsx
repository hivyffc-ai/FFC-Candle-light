...
const keyword = getKeywordBySlug('candlelight-dinner', 'private-first-date-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/private-first-date-candlelight-dinner-vadodara',
  },
};
