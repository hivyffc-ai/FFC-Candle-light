...
const keyword = getKeywordBySlug('candlelight-dinner', 'intimate-candlelight-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-candlelight-dinner-for-boyfriend-vadodara',
  },
};
