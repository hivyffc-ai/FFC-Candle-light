...
const keyword = getKeywordBySlug('candlelight-dinner', 'romantic-candlelight-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-candlelight-dinner-for-boyfriend-vadodara',
  },
};
