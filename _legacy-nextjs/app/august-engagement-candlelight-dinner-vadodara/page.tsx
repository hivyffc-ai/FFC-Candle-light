...
const keyword = getKeywordBySlug('candlelight-dinner', 'august-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/august-engagement-candlelight-dinner-vadodara',
  },
};
