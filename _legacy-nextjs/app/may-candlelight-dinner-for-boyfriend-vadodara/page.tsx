...
const keyword = getKeywordBySlug('candlelight-dinner', 'may-candlelight-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/may-candlelight-dinner-for-boyfriend-vadodara',
  },
};
