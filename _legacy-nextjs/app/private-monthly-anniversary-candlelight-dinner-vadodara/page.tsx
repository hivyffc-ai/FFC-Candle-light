...
const keyword = getKeywordBySlug('candlelight-dinner', 'private-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/private-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
