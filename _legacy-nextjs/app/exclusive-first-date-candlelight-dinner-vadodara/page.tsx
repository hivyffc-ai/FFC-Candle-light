...
const keyword = getKeywordBySlug('candlelight-dinner', 'exclusive-first-date-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/exclusive-first-date-candlelight-dinner-vadodara',
  },
};
