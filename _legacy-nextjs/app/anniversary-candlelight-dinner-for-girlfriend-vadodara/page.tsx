...
const keyword = getKeywordBySlug('candlelight-dinner', 'anniversary-candlelight-dinner-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/anniversary-candlelight-dinner-for-girlfriend-vadodara',
  },
};
