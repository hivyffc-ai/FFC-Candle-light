...
const keyword = getKeywordBySlug('candlelight-dinner', 'luxury-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/luxury-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
