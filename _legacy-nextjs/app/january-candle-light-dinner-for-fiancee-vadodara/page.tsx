...
const keyword = getKeywordBySlug('candlelight-dinner', 'january-candle-light-dinner-for-fiancee-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/january-candle-light-dinner-for-fiancee-vadodara',
  },
};
