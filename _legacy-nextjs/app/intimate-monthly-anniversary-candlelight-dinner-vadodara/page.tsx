...
const keyword = getKeywordBySlug('candlelight-dinner', 'intimate-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
