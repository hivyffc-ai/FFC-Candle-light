...
const keyword = getKeywordBySlug('candlelight-dinner', 'august-candlelight-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/august-candlelight-dinner-for-soulmate-vadodara',
  },
};
