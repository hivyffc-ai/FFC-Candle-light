...
const keyword = getKeywordBySlug('candlelight-dinner', 'june-candle-light-dinner-for-fiancee-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/june-candle-light-dinner-for-fiancee-vadodara',
  },
};
