...
const keyword = getKeywordBySlug('candlelight-dinner', 'january-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/january-anniversary-candlelight-dinner-vadodara',
  },
};
