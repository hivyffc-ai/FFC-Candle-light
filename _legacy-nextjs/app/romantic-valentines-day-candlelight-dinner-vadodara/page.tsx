...
const keyword = getKeywordBySlug('candlelight-dinner', 'romantic-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-valentines-day-candlelight-dinner-vadodara',
  },
};
