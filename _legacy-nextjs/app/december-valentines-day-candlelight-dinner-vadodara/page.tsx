...
const keyword = getKeywordBySlug('candlelight-dinner', 'december-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/december-valentines-day-candlelight-dinner-vadodara',
  },
};
