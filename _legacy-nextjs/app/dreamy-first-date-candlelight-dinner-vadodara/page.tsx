...
const keyword = getKeywordBySlug('candlelight-dinner', 'dreamy-first-date-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/dreamy-first-date-candlelight-dinner-vadodara',
  },
};
