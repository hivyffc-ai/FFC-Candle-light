...
const keyword = getKeywordBySlug('candlelight-dinner', 'september-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/september-engagement-candlelight-dinner-vadodara',
  },
};
