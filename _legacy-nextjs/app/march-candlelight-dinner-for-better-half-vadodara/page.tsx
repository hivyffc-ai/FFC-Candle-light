...
const keyword = getKeywordBySlug('candlelight-dinner', 'march-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/march-candlelight-dinner-for-better-half-vadodara',
  },
};
