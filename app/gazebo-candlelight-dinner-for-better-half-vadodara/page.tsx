...
const keyword = getKeywordBySlug('candlelight-dinner', 'gazebo-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/gazebo-candlelight-dinner-for-better-half-vadodara',
  },
};
