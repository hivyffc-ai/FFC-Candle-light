...
const keyword = getKeywordBySlug('candlelight-dinner', 'private-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/private-valentines-day-candlelight-dinner-vadodara',
  },
};
