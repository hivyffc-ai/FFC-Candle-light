...
const keyword = getKeywordBySlug('candlelight-dinner', 'premium-candlelight-dinner-for-husband-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/premium-candlelight-dinner-for-husband-vadodara',
  },
};
