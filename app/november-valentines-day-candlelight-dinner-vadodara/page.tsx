...
const keyword = getKeywordBySlug('candlelight-dinner', 'november-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/november-valentines-day-candlelight-dinner-vadodara',
  },
};
