...
const keyword = getKeywordBySlug('candlelight-dinner', 'first-date-candlelight-dinner-for-lover-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/first-date-candlelight-dinner-for-lover-vadodara',
  },
};
