...
const keyword = getKeywordBySlug('candlelight-dinner', 'march-candle-light-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/march-candle-light-dinner-for-partner-vadodara',
  },
};
