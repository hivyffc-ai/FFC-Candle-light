...
const keyword = getKeywordBySlug('candlelight-dinner', 'exclusive-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/exclusive-valentines-day-candlelight-dinner-vadodara',
  },
};
