...
const keyword = getKeywordBySlug('candlelight-dinner', 'indoor-candlelight-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/indoor-candlelight-dinner-for-soulmate-vadodara',
  },
};
