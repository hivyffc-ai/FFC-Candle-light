...
const keyword = getKeywordBySlug('candlelight-dinner', 'exclusive-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/exclusive-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
