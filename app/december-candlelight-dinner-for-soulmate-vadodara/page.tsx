...
const keyword = getKeywordBySlug('candlelight-dinner', 'december-candlelight-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/december-candlelight-dinner-for-soulmate-vadodara',
  },
};
