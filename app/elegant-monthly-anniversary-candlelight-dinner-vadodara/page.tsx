...
const keyword = getKeywordBySlug('candlelight-dinner', 'elegant-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/elegant-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
