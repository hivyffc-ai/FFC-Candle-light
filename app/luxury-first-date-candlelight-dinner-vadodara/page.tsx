...
const keyword = getKeywordBySlug('candlelight-dinner', 'luxury-first-date-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/luxury-first-date-candlelight-dinner-vadodara',
  },
};
