...
const keyword = getKeywordBySlug('candlelight-dinner', 'august-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/august-anniversary-candlelight-dinner-vadodara',
  },
};
