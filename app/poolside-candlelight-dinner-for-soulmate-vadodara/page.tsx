...
const keyword = getKeywordBySlug('candlelight-dinner', 'poolside-candlelight-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/poolside-candlelight-dinner-for-soulmate-vadodara',
  },
};
