...
const keyword = getKeywordBySlug('candlelight-dinner', 'february-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/february-candlelight-dinner-for-better-half-vadodara',
  },
};
