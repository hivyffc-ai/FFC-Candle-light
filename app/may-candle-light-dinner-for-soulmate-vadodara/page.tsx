...
const keyword = getKeywordBySlug('candlelight-dinner', 'may-candle-light-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/may-candle-light-dinner-for-soulmate-vadodara',
  },
};
