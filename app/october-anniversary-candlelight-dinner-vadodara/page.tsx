...
const keyword = getKeywordBySlug('candlelight-dinner', 'october-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-anniversary-candlelight-dinner-vadodara',
  },
};
