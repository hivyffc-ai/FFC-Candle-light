...
const keyword = getKeywordBySlug('candlelight-dinner', 'dreamy-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/dreamy-anniversary-candlelight-dinner-vadodara',
  },
};
