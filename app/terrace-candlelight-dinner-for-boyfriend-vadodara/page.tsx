...
const keyword = getKeywordBySlug('candlelight-dinner', 'terrace-candlelight-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/terrace-candlelight-dinner-for-boyfriend-vadodara',
  },
};
