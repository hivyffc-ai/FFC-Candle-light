...
const keyword = getKeywordBySlug('candlelight-dinner', 'luxury-candlelight-dinner-for-fiance-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/luxury-candlelight-dinner-for-fiance-vadodara',
  },
};
