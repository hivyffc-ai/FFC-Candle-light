...
const keyword = getKeywordBySlug('candlelight-dinner', 'exclusive-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/exclusive-engagement-candlelight-dinner-vadodara',
  },
};
