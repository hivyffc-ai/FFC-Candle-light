...
const keyword = getKeywordBySlug('candlelight-dinner', 'starlit-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/starlit-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
