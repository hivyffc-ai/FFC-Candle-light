...
const keyword = getKeywordBySlug('candlelight-dinner', 'february-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/february-valentines-day-candlelight-dinner-vadodara',
  },
};
