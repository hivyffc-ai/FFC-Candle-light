...
const keyword = getKeywordBySlug('candlelight-dinner', 'november-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/november-candlelight-dinner-for-better-half-vadodara',
  },
};
