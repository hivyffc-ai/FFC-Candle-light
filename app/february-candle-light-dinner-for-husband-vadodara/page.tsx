...
const keyword = getKeywordBySlug('candlelight-dinner', 'february-candle-light-dinner-for-husband-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/february-candle-light-dinner-for-husband-vadodara',
  },
};
