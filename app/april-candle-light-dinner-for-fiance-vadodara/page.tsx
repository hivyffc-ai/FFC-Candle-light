...
const keyword = getKeywordBySlug('candlelight-dinner', 'april-candle-light-dinner-for-fiance-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/april-candle-light-dinner-for-fiance-vadodara',
  },
};
