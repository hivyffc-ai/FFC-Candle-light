...
const keyword = getKeywordBySlug('candlelight-dinner', 'intimate-honeymoon-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-honeymoon-candlelight-dinner-vadodara',
  },
};
