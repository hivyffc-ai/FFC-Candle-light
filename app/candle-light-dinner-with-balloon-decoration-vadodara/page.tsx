...
const keyword = getKeywordBySlug('candlelight-dinner', 'candle-light-dinner-with-balloon-decoration-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/candle-light-dinner-with-balloon-decoration-vadodara',
  },
};
