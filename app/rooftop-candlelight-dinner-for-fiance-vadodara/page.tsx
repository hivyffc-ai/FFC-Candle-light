...
const keyword = getKeywordBySlug('candlelight-dinner', 'rooftop-candlelight-dinner-for-fiance-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-candlelight-dinner-for-fiance-vadodara',
  },
};
