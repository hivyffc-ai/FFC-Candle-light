...
const keyword = getKeywordBySlug('candlelight-dinner', 'august-candlelight-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/august-candlelight-dinner-for-partner-vadodara',
  },
};
