...
const keyword = getKeywordBySlug('candlelight-dinner', 'valentines-day-candlelight-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/valentines-day-candlelight-dinner-for-better-half-vadodara',
  },
};
