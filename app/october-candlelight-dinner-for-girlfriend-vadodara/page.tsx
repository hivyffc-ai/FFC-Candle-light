...
const keyword = getKeywordBySlug('candlelight-dinner', 'october-candlelight-dinner-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-candlelight-dinner-for-girlfriend-vadodara',
  },
};
