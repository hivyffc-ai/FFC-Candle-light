...
const keyword = getKeywordBySlug('candlelight-dinner', 'exclusive-honeymoon-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/exclusive-honeymoon-candlelight-dinner-vadodara',
  },
};
