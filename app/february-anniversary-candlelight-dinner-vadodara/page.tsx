...
const keyword = getKeywordBySlug('candlelight-dinner', 'february-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/february-anniversary-candlelight-dinner-vadodara',
  },
};
