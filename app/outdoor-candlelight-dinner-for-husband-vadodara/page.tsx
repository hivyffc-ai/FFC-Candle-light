...
const keyword = getKeywordBySlug('candlelight-dinner', 'outdoor-candlelight-dinner-for-husband-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/outdoor-candlelight-dinner-for-husband-vadodara',
  },
};
