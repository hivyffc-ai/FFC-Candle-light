...
const keyword = getKeywordBySlug('candlelight-dinner', 'valentines-day-candlelight-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/valentines-day-candlelight-dinner-for-partner-vadodara',
  },
};
