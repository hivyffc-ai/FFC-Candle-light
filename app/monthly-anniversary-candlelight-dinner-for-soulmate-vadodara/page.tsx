...
const keyword = getKeywordBySlug('candlelight-dinner', 'monthly-anniversary-candlelight-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/monthly-anniversary-candlelight-dinner-for-soulmate-vadodara',
  },
};
