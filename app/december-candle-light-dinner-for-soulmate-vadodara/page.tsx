...
const keyword = getKeywordBySlug('candlelight-dinner', 'december-candle-light-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/december-candle-light-dinner-for-soulmate-vadodara',
  },
};
