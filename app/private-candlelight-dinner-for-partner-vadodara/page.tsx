...
const keyword = getKeywordBySlug('candlelight-dinner', 'private-candlelight-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/private-candlelight-dinner-for-partner-vadodara',
  },
};
