...
const keyword = getKeywordBySlug('candlelight-dinner', 'luxury-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/luxury-anniversary-candlelight-dinner-vadodara',
  },
};
