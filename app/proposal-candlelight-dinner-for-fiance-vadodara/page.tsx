...
const keyword = getKeywordBySlug('candlelight-dinner', 'proposal-candlelight-dinner-for-fiance-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/proposal-candlelight-dinner-for-fiance-vadodara',
  },
};
