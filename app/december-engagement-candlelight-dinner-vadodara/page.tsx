...
const keyword = getKeywordBySlug('candlelight-dinner', 'december-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/december-engagement-candlelight-dinner-vadodara',
  },
};
