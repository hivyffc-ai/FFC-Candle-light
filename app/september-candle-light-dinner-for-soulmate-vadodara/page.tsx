...
const keyword = getKeywordBySlug('candlelight-dinner', 'september-candle-light-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/september-candle-light-dinner-for-soulmate-vadodara',
  },
};
