...
const keyword = getKeywordBySlug('candlelight-dinner', 'october-candlelight-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-candlelight-dinner-for-soulmate-vadodara',
  },
};
