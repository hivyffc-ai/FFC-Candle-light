...
const keyword = getKeywordBySlug('candlelight-dinner', 'intimate-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-anniversary-candlelight-dinner-vadodara',
  },
};
