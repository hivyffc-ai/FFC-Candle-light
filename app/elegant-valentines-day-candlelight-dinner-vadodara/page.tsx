...
const keyword = getKeywordBySlug('candlelight-dinner', 'elegant-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/elegant-valentines-day-candlelight-dinner-vadodara',
  },
};
