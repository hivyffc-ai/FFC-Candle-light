...
const keyword = getKeywordBySlug('candlelight-dinner', 'intimate-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-engagement-candlelight-dinner-vadodara',
  },
};
