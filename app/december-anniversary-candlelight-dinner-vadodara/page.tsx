...
const keyword = getKeywordBySlug('candlelight-dinner', 'december-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/december-anniversary-candlelight-dinner-vadodara',
  },
};
