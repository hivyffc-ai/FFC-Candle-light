...
const keyword = getKeywordBySlug('candlelight-dinner', 'april-candlelight-dinner-for-fiancee-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/april-candlelight-dinner-for-fiancee-vadodara',
  },
};
