...
const keyword = getKeywordBySlug('candlelight-dinner', 'october-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-engagement-candlelight-dinner-vadodara',
  },
};
