...
const keyword = getKeywordBySlug('candlelight-dinner', 'romantic-birthday-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-birthday-candlelight-dinner-vadodara',
  },
};
