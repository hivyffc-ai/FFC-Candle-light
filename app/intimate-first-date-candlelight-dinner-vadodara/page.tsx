...
const keyword = getKeywordBySlug('candlelight-dinner', 'intimate-first-date-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-first-date-candlelight-dinner-vadodara',
  },
};
