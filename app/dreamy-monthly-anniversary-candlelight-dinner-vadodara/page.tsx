...
const keyword = getKeywordBySlug('candlelight-dinner', 'dreamy-monthly-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/dreamy-monthly-anniversary-candlelight-dinner-vadodara',
  },
};
