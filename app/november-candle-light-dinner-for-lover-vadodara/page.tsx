...
const keyword = getKeywordBySlug('candlelight-dinner', 'november-candle-light-dinner-for-lover-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/november-candle-light-dinner-for-lover-vadodara',
  },
};
