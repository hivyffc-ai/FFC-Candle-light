...
const keyword = getKeywordBySlug('candlelight-dinner', 'luxury-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/luxury-engagement-candlelight-dinner-vadodara',
  },
};
