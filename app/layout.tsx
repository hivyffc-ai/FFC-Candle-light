...
export const viewport: Viewport = {
  ...
  initialScale: 1,
  maximumScale: 5,
  themeColor: "#881337", // Rose-900 burgundy for candlelight theme
};
...
export const metadata: Metadata = {
  ...
  description:
    "Best candlelight dinner in Vadodara, Gujarat. Private rooftop dining with stunning city views, gourmet cuisine, hundreds of candles & romantic ambiance. Starting ₹4,700. Book now +91 74878 88730.",
  keywords: [
    ...
    "candlelight dinner places vadodara",
    "candlelight dinner booking vadodara",
    "romantic dinner vadodara",
    "couples dinner vadodara",
    "anniversary candlelight dinner vadodara",
