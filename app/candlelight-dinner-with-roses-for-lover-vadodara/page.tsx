...
const keyword = getKeywordBySlug('candlelight-dinner', 'candlelight-dinner-with-roses-for-lover-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/candlelight-dinner-with-roses-for-lover-vadodara',
  },
};
