...
const keyword = getKeywordBySlug('candlelight-dinner', 'march-anniversary-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/march-anniversary-candlelight-dinner-vadodara',
  },
};
