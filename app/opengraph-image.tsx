...
export const alt = 'Friends Factory Cafe - Best Candlelight Dinner in Vadodara';
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 32, color: 'rgba(255, 255, 255, 0.9)', textAlign: 'center', marginTop: 16 }}>
            Best Candlelight Dinner in Vadodara
          </div>
          <div style={{ fontSize: 22, color: 'rgba(255, 255, 255, 0.8)', textAlign: 'center', marginTop: 24 }}>
            🌹 Romantic Private Dining • Rooftop & Glass House • Couples Only
          </div>
