...
const keyword = getKeywordBySlug('candlelight-dinner', 'august-valentines-day-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/august-valentines-day-candlelight-dinner-vadodara',
  },
};
