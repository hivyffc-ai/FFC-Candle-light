...
const keyword = getKeywordBySlug('candlelight-dinner', 'dreamy-engagement-candlelight-dinner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/dreamy-engagement-candlelight-dinner-vadodara',
  },
};
