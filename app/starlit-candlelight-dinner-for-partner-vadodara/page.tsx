...
const keyword = getKeywordBySlug('candlelight-dinner', 'starlit-candlelight-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/starlit-candlelight-dinner-for-partner-vadodara',
  },
};
