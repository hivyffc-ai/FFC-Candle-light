...
const keyword = getKeywordBySlug('candlelight-dinner', 'dreamy-candlelight-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/dreamy-candlelight-dinner-for-partner-vadodara',
  },
};
