...
const keyword = getKeywordBySlug('candlelight-dinner', 'private-cabin-candlelight-dinner-for-fiance-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/private-cabin-candlelight-dinner-for-fiance-vadodara',
  },
};
